...
const editToDo = (e) => { 
    todoToEdit = e.target.closest('li'); //edytujemy nablizsze li do przycisku (wiadomka 🤓 )
...
const deleteToDo = (e) => {
    e.target.closest('li').remove(); //style.display = 'none' jak poczatkowo myslalem tez by zadzialala ale ta better 🤓
